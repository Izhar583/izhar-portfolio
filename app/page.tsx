  ...
  return (
    <>
      ...
      <nav>
        ...
        <a href="/izhar.pdf" download="Izhar_Ul_Haq_CV.pdf" className="nav-cta">Download CV</a>
      </nav>
      ...
      <section id="hero">
        <div className="hero-content">
          ...
          <div className="socials">
            ...
            <a href="https://www.linkedin.com/in/izhar-ul-haq-01b2ab2b3/" className="social-link" title="LinkedIn">
        ...
        <div className="reveal">
          ...
          <div className="about-grid">
            ...
            <div className="about-text">
              ...
              <a href="/izhar.pdf" download="Izhar_Ul_Haq_CV.pdf" className="btn-primary" style={{ display: 'inline-flex' }}>Download Resume ↓</a>
            </div>
          </div>
        </div>
      </section>
